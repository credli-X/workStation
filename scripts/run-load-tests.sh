...
if ! command -v k6 &> /dev/null; then
    ...
    if [[ "$OSTYPE" == "linux-gnu"* ]]; then
        sudo gpg -k
        sudo gpg --no-default-keyring --keyring /usr/share/keyrings/k6-archive-keyring.gpg --keyserver hkps://keyserver.ubuntu.com:443 --recv-keys C5AD17C747E3415A3642D57D77C6C491D6AC1D69
